...
<body data-theme="default" id="get-theme">
    <div class="page cart-page">
        ...
        <div class="container page__body" style="display: flex; justify-content: center; align-items: center; text-align: center;">
            ...
            ?>
                ...
                <div class="cart-page__contents" style="text-align: center;">
                ...
                <div class = "row">
                    ...
                    <div class="cart-page__contents__aside" style="margin-top: 100px;">
