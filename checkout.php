...
?>
        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" id="paypal-submit" method="post" class="paypal">
            ...
            <input type="hidden" name="business" value="sb-g0q3b29900484@business.example.com">
            <!-- Buy Now button. -->
            ...
            <!-- URLs -->
            <input type='hidden' name='cancel_return' value='http://localhost/AllGrocersHub/error-page.php'>
            <input type='hidden' name='return' value='http://localhost/AllGrocersHub/success-page.php?userId=<?php echo $user_id ?>&payment=true&orderId=<?php echo $orderplace_id ?>'>
            <!-- payment button. -->
